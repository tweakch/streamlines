...
**Rückblickend ist dieses Labor die erste Naturengine** (Kap. 4) – mit genau einer Komponente. Es rechnet einen Weltzustand aus wenigen Regeln über echtem Gelände, es hat Gedächtnis statt einer Zustandsfunktion, und es lässt sich an belegten Fixpunkten widerlegen: die elf △-Marken und die sieben Gegenproben *sind* das Tor-Prinzip, nur auf eine Grösse und auf Orte statt auf Zeitschnitte angewendet. Der JSON-Export der Endlage (Gelände je Feld plus Fundstellen-Kandidaten mit lon/lat) ist inhaltlich, was dort `natur.zustand` heisst. Und die teuerste Lehre gilt für fünf Tore erst recht: **eine einzige Parametereinstellung traf nie alle elf Lappen gleichzeitig** – Dombes, Villafranca, Memmingen, Salzachlappen, Judenburg und Brianza werden bis heute nicht erreicht. Wer von einem Modell verlangt, 40 000 Jahre und einen ganzen Weltzustand gleichzeitig zu treffen, sollte das gelesen haben, bevor er den Optimierer anwirft. {.dim}
